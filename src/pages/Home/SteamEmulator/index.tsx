/*
 English: 
 SteamEmulator component. Interleaves the provided text with the heavy GIFs to create an authentic Steam Store layout.
 Includes the Early Access QA block as requested.
 
 Explicação em português aqui: 
 Componente SteamEmulator. Intercala o texto fornecido com os GIFs pesados para criar um layout autêntico da Loja Steam.
 Inclui o bloco de Perguntas e Respostas de Acesso Antecipado conforme solicitado.
 
 Caminho / Path: src/components/home/SteamEmulator/index.tsx
*/

import React from "react";
import * as S from "./styles";

// English: Ensure these GIFs are placed in your src/assets folder
// Explicação em português aqui: Certifique-se de que esses GIFs estejam colocados na sua pasta src/assets
...
const SteamEmulator: React.FC = () => {
  return (
    <S.SteamSectionContainer>
      <S.SteamWrapper>
